...
describe("ForgotPasswordComponent", () => {
  ...
  beforeEach(waitForAsync(() => {
    securityQuestionService = jasmine.createSpyObj("SecurityQuestionService", [
      "find",
    ]);
  ...
  it("should load security questions on init", () => {
    const questions = [{ id: 1, question: "What is your favorite test tool?" }];
    securityQuestionService.find.and.returnValue(of(questions));

    fixture = TestBed.createComponent(ForgotPasswordComponent);
    component = fixture.componentInstance;
    fixture.detectChanges();

    expect(securityQuestionService.find).toHaveBeenCalledWith(null);
    expect(component.securityQuestions).toEqual(questions);
  });

  it("should keep security questions empty when loading fails", () => {
    securityQuestionService.find.and.returnValue(
